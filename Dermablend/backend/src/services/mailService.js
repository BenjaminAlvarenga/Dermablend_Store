...
/**
 * Sends a password recovery email to a client (web link + short code for the mobile app)
 * @param {string} toEmail - Recipient email address
 * @param {string} code - 6-digit numeric recovery code
 */
export async function sendRecoveryEmail(toEmail, code) {
    // Recovery link for the web flow (auto-fills the code from the URL)
    const recoveryUrl = `http://localhost:5173/reset-password?token=${code}`;
    ...
    const mailOptions = {
        ...
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #E8E2DA; border-radius: 8px;">
                ...
                <p>Usa el siguiente código en la app o en la pantalla de recuperación. Este código expira en 1 hora.</p>
                ...
                <p>Si estás en la computadora, también puedes hacer clic en el siguiente botón para continuar directamente:</p>
    ...
    try {
        ...
        // Fallback log of the recovery code for debugging/testing
